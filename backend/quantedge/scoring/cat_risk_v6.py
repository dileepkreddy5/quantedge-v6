...
CATEGORIES = {
 "bankruptcy": ("Bankruptcy & Solvency Risk", 0.90, [
   _s("altman_z","Altman Z-score","altman_z",0.30,1.8,3.5,evidence=">3 safe, <1.8 distress zone"),
   _s("bankruptcy_prob","Bankruptcy probability","bankruptcy_prob",0.25,0.15,0.02,hib=False,evidence="Ohlson-derived default probability"),
 ...
 "leverage": ("Financial Leverage Risk", 0.70, [
   _s("debt_to_equity","Debt-to-equity","debt_to_equity",0.22,1.5,0.3,hib=False,evidence="leverage vs equity"),
 ...
 "volatility": ("Volatility Structure", 0.50, [
 ...
 "business_model": ("Business Model Risk", 0.60, [
 ...
 "valuation_risk": ("Valuation Risk", 0.50, [
   _s("val_downside","Valuation downside risk","valuation_downside_risk",0.35,0.7,0.2,hib=False,evidence="multiple-compression exposure"),
   _s("pe","P/E ratio","pe_ratio",0.30,40,15,hib=False,evidence="high P/E = more downside on miss"),
 ...
 "governance": ("Governance & Dilution Risk", 0.40, [
...
def risk_rating(score):
    ...
    if score>=72: return "Low Risk"
    if score>=58: return "Moderate Risk"
    if score>=42: return "Elevated Risk"

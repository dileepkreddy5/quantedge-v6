...
CATEGORIES = {
 ...
 "competitive_position": ("Competitive Position", 1.20, [
   ...
   _s("relative_growth_vs_industry","Growth vs industry","relative_growth_vs_industry",0.0,0.0,0.1,status="needs_source",evidence="needs enriched peer fundamentals"),
   _s("roic_percentile_vs_peers","ROIC percentile vs peers","roic_percentile_vs_peers",0.0,50,80,status="needs_source",evidence="needs enriched peer fundamentals"),
   _s("margin_percentile_vs_peers","Margin percentile vs peers","margin_percentile_vs_peers",0.0,50,80,status="needs_source",evidence="needs enriched peer fundamentals"),
   _s("growth_percentile_vs_peers","Growth percentile vs peers","growth_percentile_vs_peers",0.0,50,80,status="needs_source",evidence="needs enriched peer fundamentals"),
   _s("scale_rank","Scale rank","scale_rank",0.0,50,80,status="needs_source",evidence="needs enriched peer fundamentals"),

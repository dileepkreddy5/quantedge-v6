...
MODULE_REGISTRY = [
    ...
    {"id":"business",      "label":"Business Intelligence",      "weight":12, "status":"pending"},
    {"id":"valuation",     "label":"Valuation Intelligence",     "weight":10, "status":"pending"},
    ...
    {"id":"market",        "label":"Market Intelligence",        "weight":5,  "status":"pending"},

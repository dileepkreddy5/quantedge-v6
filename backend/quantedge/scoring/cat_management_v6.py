...
CATEGORIES = {
 "capital_allocation":("Capital Allocation",1.10,[
 ...
 "insider_activity":("Insider Activity",1.00,[
 ...
 "effectiveness":("Management Effectiveness",1.00,[
   ...
   _s("margin_current","Current margin","margin_current",0.14,0.10,0.30,evidence="operating margin level")]),
 "alignment":("Shareholder Alignment",0.85,[
 ...
 "execution":("Execution Quality",0.75,[
 ...
 "governance":("Governance & Discipline",0.70,[
 ...
 "profitability_quality":("Profitability Quality",0.60,[
